<!-- MODAL UPDATE TAMU -->
<div class="modal fade" id="popUpUpdate-Tamu_<?php echo $row['id_sampah']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title" id="myModalLabel">Perbarui Data Tamu</h3>
			...
			<div class="modal-body modal-form-tamu">
				...
				<form method="POST" action="ubah_data_tamu.php?id_tamu=<?php echo $row['id_tamu']; ?>">
					<div class="form-group row">
					    ...
					    <div class="col-sm-9">
					    	<input type="text" name="updt_nama_tamu" class="form-control" id="input_nama_tamu" placeholder="Inputkan Nama Tamu" required value="<?php echo $row['nama_tamu']; ?>">
					    </div>
				  	</div>
				  	<div class="form-group row">
