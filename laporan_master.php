...
// JUMLAH NASABAH
	$nasabah = $koneksi->prepare($nasabah);
	$nasabah->execute();
	$jum_nasabah = $nasabah->rowCount();

// JUMLAH SAMPAH
	$sampah = $koneksi->prepare($sampah);
	$sampah->execute();
	$jum_sampah = $sampah->rowCount();
	...
	<div class="bungkus-terluar bg-dark">
	    ...
	    <div id="content">
	        ...
	        <div class="container index-dashboard">
	        	...
	        	<div class="row">
	        		...
	        		<div class="col-sm-3">
	        			<div class="dashboard-content ">
	        				<a href="data_nasabah.php" title="Lihat Nasabah">
	        		...
	        		<div class="col-sm-3">
	        			<div class="dashboard-content">
	        				<a href="data_sampah.php" title="Lihat Sampah">
	        				<p class="title-content">BERAT TOTAL SAMPAH (Kg)</p>
	        				<p class="keterangan"><?php echo "$jum_sampah"; ?></p>
	        		...
	        		<div class="col-sm-3">
	        			<div class="dashboard-content">
	        				<a href="data_setoran.php" title="Lihat Setoran Hari Ini">
	        				<p class="title-content">BANYAK SETORAN SAMPAH</p>
	        	...
	        	<div class="row">
	        		<div class="col-sm-12 title-dashboard-content text-center">
	        			<p>Laporan Master Data dan Transaksi</p>
	        			<hr>
	        		</div>
	        		<div class="col-sm-3">
	        			<div class="dashboard-content ">
