...
<!-- CONTEN TABLE -->
	<div class="container table-tamu ">
		<div class="wrapper-table">
			<form method="post" action="proses_penarikan_add.php" id="form-delete">
				 <?php 
									include 'koneksi.php';
...
?>
			...
			<div class="text-center"><h4>PENARIKAN SALDO NASABAH</h4></div>
						...
						<table id="tb-setoran_sampah" class="table table-striped nowrap table-hover table-sm  table-bordered "  cellspacing="0" width="100%">
					        <thead class="thead-dark text-center">
					            <tr>
					                ...
					                <th class="header-table"  >Id Nasabah</th>
					                <th class="header-table" >Nama Nasabah</th>
					                <th class="header-table" >Jumlah Penarikan</th>
					                <!-- <th class="header-table " >Sisa Saldo</th> -->
					        ...
					        <tbody>
					            <?php
						            ...
						            require 'koneksi.php'; 
									$sql = "
											SELECT penarikan_saldo.*, nasabah.* 
											FROM penarikan_saldo
											INNER JOIN nasabah
											on penarikan_saldo.id_nasabah = nasabah.id_nasabah
											ORDER BY id_penarikan DESC
									...
									foreach ($koneksi->query($sql) as $row) {
										...
										<tr>
											...
											<td>Rp. <?php echo $row['jumlah_tarik']; ?></td>
