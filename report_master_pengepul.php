...
// JUMLAH LAKI
	$laki = $koneksi->prepare('SELECT * FROM pengepul WHERE jenis_kelamin = "Laki-laki"');
	$laki->execute();
	$jumlah_laki = $laki->rowCount();
	$perempuan = $koneksi->prepare('SELECT * FROM pengepul WHERE jenis_kelamin = "Perempuan"');
	$perempuan->execute();
...
<head>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Persentase Jumlah Pengepul Berdasarkan Jenis Kelamin'
        };
	        	...
	        	<div class="container table-tamu ">
	        		<nav aria-label="breadcrumb">
					  <ol class="breadcrumb">
					    ...
					    <li class="breadcrumb-item active" aria-current="report_master_pengepul.php">Laporan Pengepul</li>
					  </ol>
					</nav>
